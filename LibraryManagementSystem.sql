...
# 6. Display the names of customers who have issued books in the month of June 2023.
...
# 7. Retrieve book_title from book table containing 'history'.
SELECT book_title FROM books WHERE Category = 'history';

# 8.Retrieve the branch numbers along with the count of employees for branches having more than 5 employees.
